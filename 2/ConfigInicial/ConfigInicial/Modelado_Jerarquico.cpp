...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Modelado jerarquico - Vázquez Dávila Paul", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Model Palma
		//"model temp es un checkpoint para no regresar al origen y hacer de nuevo la transformación
		...
		model = glm::rotate(model, glm::radians(dedo3_1), glm::vec3(0.0f, 0.0f, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(0.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//Model dedo4.1
		model = glm::translate(modelTemp2, glm::vec3(0.25f, -0.35f, 0.0f));
		model = glm::rotate(model, glm::radians(dedo4_1), glm::vec3(0.0f, 0.0f, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(0.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
